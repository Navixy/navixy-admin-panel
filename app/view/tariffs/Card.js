Ext.define('NavixyPanel.view.tariffs.Card', {
    ...
    prepareHeaderData: function () {
        ...
        return {
            ...
            title_add: this.checkDefault() ? Ext.String.format(_l.get('tariffs.fields.default_tariff'), _l.get('devices')[recordData.device_type]) : false,
            ...
            fields: [
                ...
                {
                    title: _l.get('tariffs.fields.outgoing_sms'),
                    value: '<span class="pre_note">' + recordData.outgoing_sms + '</span> <span class="note" data-qtip="' + _l.get('tariffs.fields.service_price') + '">+' + tariffPrices.outgoing_sms + '</span>',
                    no_encode: true
                },
                {
                    title: _l.get('tariffs.fields.incoming_sms'),
                    value: '<span class="pre_note">' + recordData.incoming_sms + '</span> <span class="note" data-qtip="' + _l.get('tariffs.fields.service_price') + '">+' + tariffPrices.incoming_sms + '</span>',
                    no_encode: true
                },
                {
                    title: _l.get('tariffs.fields.service_sms'),
                    value: '<span class="pre_note">' + recordData.service_sms + '</span> <span class="note" data-qtip="' + _l.get('tariffs.fields.service_price') + '">+' + tariffPrices.service_sms + '</span>',
                    no_encode: true
                },
                {
                    title: _l.get('tariffs.fields.phone_call'),
                    value: '<span class="pre_note">' + recordData.phone_call + '</span> <span class="note" data-qtip="' + _l.get('tariffs.fields.service_price') + '">+' + tariffPrices.phone_call + '</span>',
                    no_encode: true
                },
                {
    ...
    prepareBodyLeftData: function () {
        ...
        return {
            ...
            fields: [
                {
                    title: _l.get('tariffs.fields.device_limit_exp'),
                    value: recordData.device_limit,
                    no_empty: true
                },
                {
                    title: _l.get('tariffs.fields.group_id_exp'),
                    value: recordData.group_id,
                    no_empty: true
                },
                {
                    title: _l.get('tariffs.fields.store_period'),
                    value: Ext.util.Format.unitsDecode(recordData.store_period),
                    no_empty: true
                },
                {
                    title: _l.get('tariffs.fields.has_reports'),
                    value: _l[recordData.has_reports ? 'yes' : 'no'],
                    no_empty: true
                },
                {
                    title: _l.get('tariffs.fields.active'),
                    value: _l[recordData.active ? 'yes' : 'no'],
                    no_empty: true
                },
                {
                    title: _l.get('tariffs.fields.proportional_charge'),
