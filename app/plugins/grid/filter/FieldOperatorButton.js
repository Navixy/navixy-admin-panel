 ...
 */
Ext.define('NavixyPanel.plugins.grid.filter.FieldOperatorButton', {
    ...
    updateOperatorButtonVisibility: function () {
        ...
        if (!Ext.isWebKit) {
            padding = (newVisible ? 22 : 5);
        } else {
            padding = (newVisible || !me.webKitBugFlag ? 22 : 5);
    ...
    repositionOperatorButton: function () {
        ...
        btn.alignTo(this.textField.bodyEl, 'tl-tl', [4, 6]);
    }
});
