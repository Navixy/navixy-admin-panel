...
Ext.define('NavixyPanel.plugins.grid.filter.GridFilterBar', {
    extend: 'Ext.AbstractPlugin',
    alias: 'plugin.filterbar',
    uses: [
        'Ext.window.MessageBox',
        'NavixyPanel.plugins.grid.filter.FieldClearButton',
        'NavixyPanel.plugins.grid.filter.FieldOperatorButton',
    ...
    setup: function (grid) {
        ...
        grid.addDocked(
            me.filterBar = Ext.create('Ext.container.Container', {  // adds a filter bar to grid
                ...
                dock: 'top',
                border: true,
                baseCls: Ext.baseCSSPrefix + 'grid-header-ct filter-bar-ct',
    ...
    renderButtons: function () {
        ...
        if (me.showShowHideButton && me.columns.getCount()) {
            ...
            me.showHideEl.on('click', function () {
                ...
                me.showHideEl[!me.isVisible() ? 'removeCls' : 'addCls']('active');
            });
        }
                    ...
                    case 'eq':
                        filterFn = function (item) {
                            if (column.filter.type == 'date') {
                                console.log(item, column.dataIndex, newVal);
