 ...
 *
 */
Ext.define('NavixyPanel.plugins.grid.plugin.GroupingPanel', {
    extend: 'Ext.AbstractPlugin',
    requires: [
        'NavixyPanel.plugins.grid.plugin.grouping.Container',
        'NavixyPanel.plugins.grid.plugin.grouping.Column',
        'NavixyPanel.plugins.grid.plugin.grouping.DragZone',
        'NavixyPanel.plugins.grid.plugin.grouping.DropZone',
        'NavixyPanel.plugins.grid.plugin.grouping.GridDropZone'
    ],
    ...
    init: function(grid) {
        ...
        me.listenersRender = me.grid.on({
            beforerender: function(){
                me.groupingCt = me.grid.addDocked(Ext.create('NavixyPanel.plugins.grid.plugin.grouping.Container',{
                    panelPlugin: me
                }))[0];
            },
            afterrender: function(){
                me.dragZone = new NavixyPanel.plugins.grid.plugin.grouping.DragZone(me.groupingCt);
                me.dropZone = new NavixyPanel.plugins.grid.plugin.grouping.DropZone(me.groupingCt);
                me.gridDropZone = new NavixyPanel.plugins.grid.plugin.grouping.GridDropZone(me.grid);
        ...
        me.grid.addEvents(
            /**
            * @event groupchange
            * @param {NavixyPanel.plugins.grid.plugin.GroupingPanel} panel
