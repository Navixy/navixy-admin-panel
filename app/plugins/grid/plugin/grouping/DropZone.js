 ...
 * @private
 */
Ext.define('NavixyPanel.plugins.grid.plugin.grouping.DropZone', {
    ...
    getLocation: function(e, t) {
        ...
        if(target instanceof NavixyPanel.plugins.grid.plugin.grouping.Container){
    ...
    positionIndicator: function(data, node, e){
        ...
        if ((dragHeader !== targetHeader) &&
            ...
            if(targetHeader instanceof NavixyPanel.plugins.grid.plugin.grouping.Container && targetHeader.items.getCount() > 0){
    ...
    onNodeDrop: function(node, dragZone, e, data) {
        ...
        if (me.valid && dropLocation){
            ...
            */
            ...
            }else if(dragColumn instanceof NavixyPanel.plugins.grid.plugin.grouping.Column){
                // 2nd possibility
                me.panel.moveColumn(dragColumn.id, dropLocation.header instanceof NavixyPanel.plugins.grid.plugin.grouping.Container ? dropLocation.header.items.last().id : dropLocation.header.id, dropLocation.pos);
            }
