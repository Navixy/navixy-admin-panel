 ...
 * @private
 */
Ext.define('NavixyPanel.plugins.grid.plugin.grouping.Container', {
    ...
    */
    ...
    addColumn: function(config, pos, notify){
        ...
        newCol = Ext.create('NavixyPanel.plugins.grid.plugin.grouping.Column', config);
    ...
    getColumnPosition: function(column, position){
        ...
        if(column instanceof NavixyPanel.plugins.grid.plugin.grouping.Column){
