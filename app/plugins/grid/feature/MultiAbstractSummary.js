...
*/
Ext.define('NavixyPanel.plugins.grid.feature.MultiAbstractSummary', {
    ...
    mixins: {
        mixSummary:     'NavixyPanel.plugins.grid.feature.MixinSummary'
    },
    ...
    // overwrite the default function to call the NavixyPanel.plugins.grid.feature.MixinSummary mixin
    getSummary: function () {
