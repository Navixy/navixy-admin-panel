 ...
 */
Ext.define('NavixyPanel.plugins.grid.feature.MultiGrouping', {
    extend: 'Ext.grid.feature.Feature',
    mixins: {
        summary: 'NavixyPanel.plugins.grid.feature.MultiAbstractSummary'
    },
    requires: [
        'NavixyPanel.plugins.grid.feature.MultiGroupStore',
        'NavixyPanel.plugins.grid.feature.MultiAbstractSummary',
        'NavixyPanel.plugins.grid.feature.TableLayout'
    ],
...
//            'debugger;\n',
    ...
    init: function (grid) {
        ...
        if(store.remoteSort === true || store.remoteGroup === true){
        ...
        if (view.store.buffered) {
            ...
            me.dataSource = view.dataSource = new NavixyPanel.plugins.grid.feature.MultiGroupStore(me, view.store);
        }
    ...
    */
    ...
    onSelectionChange: function(sm, selected, eOpts){
        ...
        if(selected.length == 1){
            ...
            }else if(sm instanceof NavixyPanel.plugins.grid.selection.MultiCellModel){
                key = me.getGroupKey(selected[0]);
            }
            if(!Ext.isEmpty(key)){
