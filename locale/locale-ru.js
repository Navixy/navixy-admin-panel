...
Ext.define('Locale.locale-ru', {
    ...
    "codes": {
        ...
        "list": {
            ...
            "edited_tip": "изменен",
            "faq_link": "https://www.navixy.com/docs/user/admin-panel-docs/activation-codes/",
    ...
    "features": {
        "api": "API",
        "app_tasks": "<a href='https://www.navixy.com/docs/user/web-interface-docs/tasks/' target='_blank'>Задания</a>",
        "app_fleet": "Автопарк",
        "app_reports": "<a href='https://www.navixy.com/docs/user/web-interface-docs/reports-docs/' target='_blank'>Отчеты</a>",
        ...
        "report_scheduled": "<a href='https://www.navixy.com/docs/user/web-interface-docs/reports-docs/scheduled-reports/' target='_blank'>Запланированные отчеты</a>",
