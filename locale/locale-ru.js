    ...
    'settings': {
        ...
        'security': {
            ...
            '2fa': {
                ...
                'title_short': '2-факторная аутентификация',
                'email': 'E-Mail',
                'authenticator_app': 'Приложение для аутентификации (скоро)',
                'sms': 'SMS (скоро)',
            },
            'confirm': {
                'title': 'Применить настройки безопасности?',
                'text': 'Настройки безопасности будут применены ко всем пользователям платформы, кроме демо-пользователя.',
                'btn': {
                    'apply': 'Применить',
                    'cancel': 'Отмена',
                }
