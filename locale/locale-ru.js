...
Ext.define('Locale.locale-ru', {
    ...
    bundles: {
        ...
        menu: {
            ...
            scan: 'Привяка сим-карты к маячку',
            shipping: 'Отгрузка'
        },
        fields: {
            id: 'ID',
        ...
        scan: {
            ...
            hints: {
                ...
                iccid_found: 'IMEI найден. С ним уже связан ICCID-код "{0}".<br>Вы можете сканировать новый ICCID-код, изменить его вручную или отвязать сим-карту',
                ...
                iccid_unassign_btn: 'Отвязать сим-карту',
                iccid_print_btn: 'Распечатать наклейку',

                last_scan_text: 'Результаты предыдущего сканирования:',

                unassign_q: 'Отвязать сим-карту от устройства?',
                unassign_success: 'Сим-карта отвязана от устройства',
                unassign_failure: 'Ошибка. Не удалось отвязать сим-карту от сустройсва'
            }
        }
    }
});