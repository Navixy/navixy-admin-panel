...
Ext.define('Locale.locale-ru',{
    ...
    "settings": {
        ...
        "edit_form": {
            ...
            "service_maps_preview_info": "Вам представлен пример отображения первоначального вида карты в интерфейсе пользователя. Вы можете изменить настройки центра карты переместив маркер, и массштаб воспользовавшись инструментов или колесом мыши на карте."
        },
        "upload_form": {
            "save_btn": "Загрузить",
            "cancel_btn": "Отмена",
