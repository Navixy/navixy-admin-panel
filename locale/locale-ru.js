...
Ext.define('Locale.locale-ru',{
    ...
    "settings": {
        ...
        "edit_form": {
            ...
            "sms_m2m_info": "Сервис для обмена M2M-сообщениями между сервис-платформой и устройствами через SMS-канал играет важную роль для простой активации и удаленного управления.<br /><br />С помощью SMS-сообщений выполняется:<br /><ul><li>первоначальная автоматическая активация (APN, адрес сервара и др.) абсолютного большинства устройств</li><li>прием от устройств подтверждений о выполнении ими SMS-команд</li><li>резервный прием информации о местонахождении по SMS-каналу, когда GPRS-канал недоступен (низкий уровень сигнала, международный роуминг и т.д.) – для моделей с поддержкой такой функции)</li></ul><br /><br />Более того, для тех бюджетных моделей, которые не имеют возможностей управления ими по каналу GPRS/IP, изменение настроек их работы и управление выходами также производится с помощью канала SMS.",
