...
Ext.define('Locale.locale-ru',{
    ...
    "tariffs": {
        ...
        "fields": {
            ...
            "proportional_charge": "Пропрциональное списание",
        ...
        "card": {
            ...
            "hints": {
                "1": "Абонентскую плату за неполный месяц списывать пропорционально числу дней",
    ...
    "features": {
        ...
        "priority_support": "Поддержка приоритетов",
