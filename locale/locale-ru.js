...
Ext.define('Locale.locale-ru', {
    ...
    "settings": {
        ...
        "edit_form": {
            ...
            "google_maps_alert": 'Требует предоставления идентификаторов пользователя Карт Google или подключения пакета "Преимум ГИС" от Navixy.',
    ...
    "features": {
        "api": "API",
        "app_tasks": "<a href='http://www.navixy.com/docs/user/web-interface-docs/tasks/' target='_blank'>Задания</a>",
        "app_fleet": "Автопарк",
        ...
        "report_scheduled": "<a href='http://www.navixy.com/docs/user/web-interface-docs/reports-docs/scheduled-reports/' target='_blank'>Запланированные отчеты</a>",
