...
Ext.define('Locale.locale-ru', {
    ...
    'settings': {
        ...
        'fields': {
            ...
            'do_not_apply_default_seetings_during_activation_hint': 'При выборе опции платформа не будет отправлять на маячок конфигурационные SMS и GPRS команды с настройками по-умолчанию. Маячок должен быть настроен вручную для его активации на платформе.',
