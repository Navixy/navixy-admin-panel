...
Ext.define('Locale.locale-ru',{
    ...
    "settings": {
        ...
        "edit_form": {
            ...
            "sms_main_info": "Настройки SMS сообщений и SMS шлюзов, обеспечивающих взаимодействие между сервис-платформой, пользователями и устройствами.<br><br>В данный момент настройки SMS отключены, для изменения параметров обратитесь в техническую поддержку.",
