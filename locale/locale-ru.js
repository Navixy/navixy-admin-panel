...
Ext.define('Locale.locale-ru', {
    ...
    "settings": {
        ...
        "fields": {
            ...
            "do_not_apply_default_seetings_during_activation": "Не применять дефолтные настройки при активации маячка",
            "do_not_apply_default_seetings_during_activation_hint": "При выборе данной опции, платформа не будет отправлять на маячок конфигурационные SMS и GPRS команды с дефолтными настройками. Маячок должен быть настроен вручную перед его активацией на платформе.",
