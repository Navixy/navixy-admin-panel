    ...
    "users": {
        ...
        "corrupt": {
            "alert": {
                ...
                "text": "Пользователь и все его подпользователи будут безвозвратно удалены из базы данных, все данные - недоступны!<br><br>Вы уверены что хотите удалить пользователя?"
            },
