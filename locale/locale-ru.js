...
Ext.define('Locale.locale-ru', {
    ...
    "settings": {
        ...
        "domain_warnings": {
            ...
            "continue": "Продолжить",
            "domain_changed": "Сервисы Google могут работать некорректно. Пожалуйста, привяжите новое доменное имя к вашему google maps client ID.",
            "domain_changed_no_key": "Сервисы Google могут работать некорректно. Вам необходимо обратиться в техническую поддержку для получения доступа к сервисам Google с нового доменного имени.",
            "domain_changed_empty_key_no_gis": "Сервисы Google будут заблокированны. Вам необходимо подключить Premium GIS или обратиться в техническую поддержку, если у вас есть свой google maps client ID."
        }
    },
    "accounting": {
        "menu_text": "Выгрузки",
