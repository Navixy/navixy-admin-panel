...
Ext.define('Locale.locale-en',{
    ...
    "settings": {
        ...
        "edit_form": {
            ...
            "sms_main_info": "Configure SMS messages and SMS gateways which are used for bi-directional communication between service platform and users, service platform and devices.<br>You can use same or different gateways to deliver messages to users and devices.<br><br>Currently SMS settings are disabled, to change parameters contact technical support.",
