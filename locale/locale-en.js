...
Ext.define('Locale.locale-en', {
    ...
    "errors": {
        ...
        "238": "Plan change is not allowed",
        "240": "Not allowed: too frequent plan change",
        ...
        "tariff": {
            "244": "Plan with the same name already exists"
        },
        "settings": {
    ...
    "trackers": {
        ...
        "group_owner_form": {
            "title": "Changing owner for set of devices",
            "save_btn": "Changing owner",
            "grid_clone_label": "Devices will be changed"
        },
        "tariff_form": {
            "title": "Change tariff plan for device",
            "save_btn": "Save changes",
            "repay": "Make repayment according to the old plan",
            "charge": "Charge user according to the new plan",
            "charge_sup": "for monthly based tariff plans only",
    ...
    "tariffs": {
        ...
        "default_form": {
            "title": "Settings for default plan"
        },
        "fields": {
            "tariff_id": "ID",
            "name": "Label",
            ...
            "traffic": "GPRS (for Mb)",
            "default_tariff": "default plan for: «{0}»",
            "default_short": "default",
            "service_price": "the amount charged for service usage",
            "group_id_exp": "Tariff plan group",
            "active_exp": "Users can switch to this plan themselves",
        ...
        "card": {
            ...
            "tab_panel": {
                "trackers": {
                    "title": "Devices with selected tariff plan"
                }
            }
        },
