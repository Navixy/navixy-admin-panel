...
Ext.define('Locale.locale-fr',{
    ...
    "trackers": {
        ...
        "tariff_form": {
            ...
            "save_btn": "Enregistrer les modifications",
            "repay": "Rembourser le reste du paiement tarif actuel",
            "charge": "Utilisateur de charge (selon le nouveau plan)",
    ...
    "tariffs": {
        ...
        "card": {
            ...
            "hints": {
                "2": "Messages envoyés avec le consentement de l'utilisateur ou de sa demande. Ces SMS sont envoyés depuis la plateforme de service aux utilisateurs et périphériques par l'intermédiaire de la passerelle SMS vous défini. < br / > < br / > notamment des cas d'utilisation: < br / > – Notifications des événements axés sur la géo vos utilisateurs veulent rester au courant des < br / > – commandes de M2M pour ces appareils qui peuvent être configurées sur le canal SMS seulement (par exemple configuration de périphérique, le changement de sortie), ainsi que de la demande de position manuelle via SMS (pour les modèles qui prennent en charge cette fonctionnalité).",
                "3": "Service et maintenance commandes SMS qui sont envoyés depuis la plateforme aux équipements, normalement sans aucune approbation spéciale de l'utilisateur. Par exemple, ils sont utilisés pour l'activation du dispositif automatique – pour livrer les commandes SMS d'initialisation (APN, adresse du serveur, etc.), ou quand votre équipe effectue les diagnostics de périphérique distant.",
                ...
                "7": "Si l'utilisateur atteint la limite, il ne sera pas en mesure d'ajouter ou de suivre les plus actifs sur son compte. Dans le cas où l'utilisateur possède des atouts sur différents plans, la valeur minimale s'appliquera.",
                ...
                "16": "Cochez la case si vous permettez aux utilisateurs de passer leurs appareils sur ce plan (d'autres régimes du même groupe) en leur propre.",
                "17": "Le plan est défini par défaut pour tous les périphériques ajoutés par l'utilisateur, si aucun code d'activation utilisé. < br / > < br / &gt; lorsque l'utilisateur entre un code d'activation, ses paramètres sont utilisés comme primaire.",
                "18": "Quantité d'utilisateur jours gratuits obtient après l'ajout d'un périphérique (y compris le jour lorsque le périphérique a été ajouté).",
                "19": "Montant d'argent gratuit imputé au solde de l'utilisateur après il ajoute un nouveau périphérique. < br / > < br / &gt; il ne peut pas être utilisé pour les paiements des services généraux, mais seulement pour des services supplémentaires, par exemple les notifications par SMS.",
                "20": "Si la case est cochée, l'utilisateur sera facturé proportionnellement à la quantité de jours restants à partir de la date du dernier paiement jusqu'à la fin du mois courant. < br / > < br / &gt; si la case à cocher est désactivée, l'utilisateur toujours prélève une taxe mensuelle complète après le service pour le périphérique a été renouvelé. Par exemple, si l'utilisateur n'a pas payé à temps et rempli son équilibre sur le 10e jour, il prélève pour le mois complet en tout cas.",
                ...
                "plan_availability": "En combinant les plans en groupes, vous pouvez mieux organiser vos plans et permettre à vos utilisateurs de basculer entre les plans de leur propre chef. Alors que vous pouvez assigner n'importe quel plan pour tout actif dans le panneau Admin, vos utilisateurs sont en mesure de passer uniquement les plans qui sont marqués avec la case à cocher appropriée."
            }
        },
    ...
    "features": {
        "api": "API",
        "app_tasks": "<a href='http://www.navixy.com/docs/user/web-interface-docs/tasks/' target='_blank'> tâches</a>",
        "app_fleet": "Flotte",
        "app_reports": "<a href='http://www.navixy.com/docs/user/web-interface-docs/reports-docs/' target='_blank'> rapports</a>",
        ...
        "report_scheduled": "<a href='http://www.navixy.com/docs/user/web-interface-docs/reports-docs/scheduled-reports/' target='_blank'> rapports réguliers</a>",
        "routing": "Routage",
