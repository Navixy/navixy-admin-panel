Ext.define('Locale.Manager', {
    ...
    _locales: [
        ...
        {id: 'de_DE', name: 'de', text: 'German - Deutsch', alias: ['de', 'de_DE', 'de_AT']},
        {id: 'ru_RU', name: 'ru', text: 'Russian - Русский', alias: ['ru', 'ru_RU', 'Русский']},
        {id: 'uk_UA', name: 'uk', text: 'Ukrainian - Українська', alias: ['ua', 'uk', 'uk_UA']}
    ...
    _ui_locales: [
        ...
        {id: 'de_DE', name: 'de', text: 'Deutsch', alias: ['de', 'de_DE', 'de_AT'], rtl: false},
        {id: 'ru_RU', name: 'ru', text: 'Russian - Русский', alias: ['ru', 'ru_RU', 'Русский'], rtl: false},
        {id: 'uk_UA', name: 'uk', text: 'Українська', alias: ['ua', 'uk', 'uk_UA'], rtl: false},
