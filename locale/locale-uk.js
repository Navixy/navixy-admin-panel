...
Ext.define('Locale.locale-uk',{
    ...
    "units_combination": {"days":"днів|день|днів","hours":"годин|година|годин","minutes":"хвилин|хвилина|хвилин","seconds":"секунд|секунда|секунд","everyminutes":"хвилин|хвилина|хвилин","everyseconds":"секунд|секунда|секунд","meters":"метри|метр|метри","degrees":"градусів|градус|градусів","objects":"об'єкти|об'єкт|об'єкти","years":"роки|рік|роки","months":"місяців|місяць|місяців","codes":"коди|код|коди","trackers":"трекери|трекер|трекери","devices":"пристрої|пристрій|пристрої","entries":"співпадає|матч|співпадає","assets":"assets|asset|assets"},
    "units_short": {
        "kilometer": "км",
        "meter": "м",
